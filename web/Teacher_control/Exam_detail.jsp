...
<input type="button" name="ADD" value="新增选择题" onclick="location.href='../Admin_control\\Exam\\add_choice.jsp?Exam_id=<%=request.getParameter("Exam_id")%>'">

<input type="button" name="ADD" value="新增判断题" onclick="location.href='../Admin_control\\Exam\\add_judge.jsp?Exam_id=<%=request.getParameter("Exam_id")%>'">
</body>
</html>
